...
<body>
  ...
  <div class="jumbotron" style="opacity: 0.8">
    <h1>上传文件</h1>
    <form action="upload_c.php" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-6 col-xs-12">
          ...
          <label class="btn btn-primary" for="fileSelect" >
                选择文件&hellip;
            </label><input type="file" name="userfile" id="fileSelect" style="visibility:hidden;" onchange="cli()">
  ...
  <aside id="aside" class="sidebar col-sm-3 col-md-2 hidden-print small">
    <div class="sidebar-content">
        <div class="sidebar-body collapse in">
            <p>
                <img src="./img/c.jpg" style="position: fixed; bottom: -180px; left: -230px; opacity: 0.6; z-index: -100" alt="">
            </p>
        </div>
    </div>
</aside>
